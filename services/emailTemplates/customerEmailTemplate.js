 ...
 */
export const generateCustomerEmailTemplate = (metadata, todayDate) => {
  const {
    orderId,
    cartItems,
    subTotal,
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f5f5f5;" width="100%">
    <tbody>
      <tr>
        <td>
          <!-- Header -->
          <table align="center" border="0" cellpadding="0" cellspacing="0" style="width: 650px; background: linear-gradient(135deg, #8B7355 0%, #A0826D 100%); box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            <tbody>
              <tr>
                <td style="padding: 40px 20px; text-align: center;">
                  <h2 style="color: #fff; margin: 0; font-size: 28px; letter-spacing: 0.5px;">Order Confirmed</h2>
            ...
            <tbody>
              <tr>
                <td style="padding: 30px;">
                  ...
                  <!-- Items Section -->
                  <h3 style="color: #333; font-size: 16px; margin: 30px 0 20px 0; text-transform: uppercase; letter-spacing: 0.5px; border-left: 3px solid #8B7355; padding-left: 12px;">Order Items</h3>
                  ${itemsHTML}
                  ...
                  <table style="width: 100%; margin-top: 30px; background-color: #f9f9f9; border-radius: 4px;">
                    <tr>
                      <td style="padding: 15px 20px; border-bottom: 1px solid #eee;">
                        ...
                        <p style="font-size: 16px; font-weight: 600; color: #8B7355; margin: 4px 0 0 0;">₦${formatPrice(
                          subTotal
                        )}</p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="padding: 18px 20px; background-color: #fff;">
                        ...
                        <p style="font-size: 24px; font-weight: 700; color: #8B7355; margin: 6px 0 0 0;">₦${formatPrice(
                          totalPrice
                        )}</p>
                      </td>
                    </tr>
                  ...
                  <h3 style="color: #333; font-size: 16px; margin: 30px 0 15px 0; text-transform: uppercase; letter-spacing: 0.5px; border-left: 3px solid #8B7355; padding-left: 12px;">Delivery Details</h3>
                  ...
                  <p style="color: #666; font-size: 13px; margin: 30px 0 0 0; line-height: 1.8;">
                    We'll notify you as soon as your order is processed and on its way. Thank you for shopping with Kaizen Brand!
                  </p>
                </td>
              </tr>
            </tbody>
            ...
            <tbody>
              <tr>
                <td style="padding: 30px; text-align: center;">
                  ...
                  <p style="margin: 8px 0 0 0; font-size: 10px; color: #666;">Made with ❤️ by <a href="https://adebisiakinade.vercel.app/" style="color: #8B7355; text-decoration: none; font-weight: 600;">Akinade</a></p>
                </td>
              </tr>
            </tbody>
          </table>

...
<body style="background-color: #f5f5f5; margin: 0; padding: 0;">
  <table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f5f5f5;" width="100%">
    <tbody>
      <tr>
        <td>
          <table align="center" border="0" cellpadding="0" cellspacing="0" style="width: 650px; background-color: #b8a06a;">
            <tbody>
              <tr>
                <td style="padding: 20px; text-align: center;">
                  <h2 style="color: #fff; margin: 0;">Order Confirmation! 🛍️</h2>
                </td>
              </tr>
            </tbody>
          </table>
              ...
              <tr>
                <td style="padding: 20px; background-color: #fff;">
                  ...
                  <p style="color: #666; font-size: 14px; margin-top: 20px;">
                    We'll update you on the status of your order. Thank you for shopping with us!
                  </p>
                </td>
              </tr>
            </tbody>
